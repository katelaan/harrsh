...
//    ("examples/models/tree.amd", "examples/datastructures/tll.sid", false),
...
//    ("examples/models/tll-cyc.amd", "examples/datastructures/tll-acyc.sid", false)
  ...
  val (modelFile, sidFile, expectedRes) = ("examples/models/three-elem-list.amd", "examples/symbolicheaps/list-to-null.sid", true)
